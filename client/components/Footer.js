            ...
            <div className="container p-4">
                <div className="row row-cols-3">
                    <div className="col-6">
                        ...
                        <p>Dew is a minimalist and natural makeup brand founded by Olive Stanley in 2019. It is also a completely fictional entity created for educational purposes.</p>
                    </div>
                    <div className="col-3">
