...
const AuthNudge = () => {
    return (
        <div className="w-75 mx-auto px-5 py-3 rounded text-center brand-pink">
            ...
            <Link to="/login"><button className="btn btn-outline-dark btn-sm mx-2" type="button" name="link">Log In</button></Link>
            <Link to="/signup"><button className="btn btn-outline-dark btn-sm mx-2" type="button" name="link">Sign Up</button></Link>
        </div>
    )
}