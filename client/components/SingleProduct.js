...
class SingleProduct extends Component {
  ...
  handleChange(event) {
    if (event.target.value > this.props.product.stock)
      event.target.value = this.props.product.stock
    this.setState({
  ...
  render() {
    ...
    } else return <div className="container min-vh-100" />
  }
}
...
const mapDispatchToProps = dispatch => ({
  ...
  addLineItem: (orderId, optionId, quantity) =>
    dispatch(addLineItem(orderId, optionId, quantity))
})
