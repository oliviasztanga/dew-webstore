    ...
    <nav className="navbar navbar-expand-md fixed-top d-flex justify-content-between navbar-light bg-light">
      ...
      <div className="">
        <ul className="navbar-nav">
          ...
          <li className="nav-link mx-3"><Link to="/face">Face</Link></li>
      ...
      <div className="">
        <ul className="navbar-nav">
            ...
            </a>
            {
              isLoggedIn ? (
                <div className="dropdown-menu">
                  ...
                  <Link to="" className="dropdown-item" onClick={() => props.logout()}>Logout</Link>
                </div>
              ) : (
                <div className="dropdown-menu">
          ...
          <li className="nav-item nav-link">
            <Link to="/cart">
              <svg className="bi bi-bag text-secondary" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
